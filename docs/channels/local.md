---
title: "Local"
description: "Use T3Claw locally via terminal or browser"
---

By default, T3Claw provides two local interfaces for chatting with your agent:
...
Simply run `t3claw` and the TUI will launch in your terminal. Use the keyboard shortcuts below to navigate and chat with your agent.
| Key | Action |
|-----|--------|
| `Enter` | Send message |
...
By default, T3Claw generates an auth token at startup and prints it in logs. To use a stable token across restarts:
