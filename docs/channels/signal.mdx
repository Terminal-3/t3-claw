...
Connect T3Claw to Signal so you can talk to your agent in direct messages.
...
The Signal channel connects T3Claw to a running [signal-cli](https://github.com/AsamK/signal-cli) HTTP daemon. Before configuring T3Claw, start signal-cli in daemon mode on your machine.
