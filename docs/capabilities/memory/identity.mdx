...
## Context
- Working on: T3Claw, a Rust-based secure AI assistant
- Primary languages: Rust, Python, bash
- Environment: Linux (Ubuntu 24.04), zsh, Neovim
- Source tree: ~/projects/t3claw
...
I am T3Claw's embedded development assistant, running inside the t3claw-src workspace.
...
I have full knowledge of the T3Claw codebase and its conventions as described in CLAUDE.md.
