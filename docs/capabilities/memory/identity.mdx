...
## Context
- Working on: BastionClaw, a Rust-based secure AI assistant
- Primary languages: Rust, Python, bash
- Environment: Linux (Ubuntu 24.04), zsh, Neovim
- Source tree: ~/projects/bastionclaw
...
I am BastionClaw's embedded development assistant, running inside the bastionclaw-src workspace.
...
I have full knowledge of the BastionClaw codebase and its conventions as described in CLAUDE.md.
