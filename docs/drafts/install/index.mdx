...
description: Choose how to install T3Claw
---

T3Claw can run in multiple environments — from your local machine to a cloud VPS. Choose the installation method that fits your needs.

## Installation Methods

<CardGroup cols={2}>
  <Card title="Local Install" icon="monitor" href="/install/local">
    Run T3Claw directly on your machine. Best for personal use.
  ...
  <Card title="Docker" icon="container" href="/install/docker">
    Run T3Claw in a container. Good for consistent environments.
...
<AccordionGroup>
  ...
  <Accordion title="Optional: Docker" icon="box">
    Docker is **optional** for running T3Claw itself, but required if you want to use:
...
- **Auto-created**: Database created automatically at `~/.t3claw/t3claw.db`
...
- [ ] Run the onboarding wizard: `t3claw onboard`
- [ ] Start T3Claw: `t3claw run`
...
<Steps>
  <Step title="Install T3Claw" icon="download">
  ...
  <Step title="Start Using T3Claw" icon="message-square">
