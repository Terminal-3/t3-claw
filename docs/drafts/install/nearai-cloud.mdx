...
description: Use NEAR AI managed hosting for BastionClaw
---

NEAR AI Cloud offers managed hosting for BastionClaw — zero setup required.

## What is NEAR AI Cloud?

NEAR AI Cloud runs BastionClaw for you on their infrastructure:
...
2. Request BastionClaw access from your NEAR AI dashboard
3. Receive your BastionClaw instance URL and credentials

## Authentication

NEAR AI Cloud uses session token authentication. Your token is automatically injected into the BastionClaw environment.

### For hosting providers

If you're deploying BastionClaw on NEAR AI infrastructure:
...
<CardGroup cols={2}>
  <Card title="Local Install" icon="monitor" href="/install/local">
    Run BastionClaw on your own machine
  </Card>
