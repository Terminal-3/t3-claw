...
description: Use NEAR AI managed hosting for T3Claw
---

NEAR AI Cloud offers managed hosting for T3Claw — zero setup required.

## What is NEAR AI Cloud?

NEAR AI Cloud runs T3Claw for you on their infrastructure:
...
2. Request T3Claw access from your NEAR AI dashboard
3. Receive your T3Claw instance URL and credentials

## Authentication

NEAR AI Cloud uses session token authentication. Your token is automatically injected into the T3Claw environment.

### For hosting providers

If you're deploying T3Claw on NEAR AI infrastructure:
...
<CardGroup cols={2}>
  <Card title="Local Install" icon="monitor" href="/install/local">
    Run T3Claw on your own machine
  </Card>
