...
description: BastionClaw's defense-in-depth security architecture
---

Security is BastionClaw's primary differentiator. Your data stays yours through multiple layers of defense.

## Security-First Design

BastionClaw is built with security as a core principle:
...
<Frame>
  <img src="/assets/security-architecture.svg" alt="BastionClaw Security Architecture Diagram" />
</Frame>
...
The security architecture illustrates BastionClaw's **defense in depth** approach with four independent protection layers that data flows through before reaching external services.
...
BastionClaw ships with secure defaults:
...
BastionClaw helps with security compliance:

| Requirement | BastionClaw Feature |
|-------------|-----------------|
...
1. Email security@bastionclaw.ai
