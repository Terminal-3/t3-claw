...
description: T3Claw's defense-in-depth security architecture
---

Security is T3Claw's primary differentiator. Your data stays yours through multiple layers of defense.

## Security-First Design

T3Claw is built with security as a core principle:
...
<Frame>
  <img src="/assets/security-architecture.svg" alt="T3Claw Security Architecture Diagram" />
</Frame>
...
The security architecture illustrates T3Claw's **defense in depth** approach with four independent protection layers that data flows through before reaching external services.
...
T3Claw ships with secure defaults:
...
T3Claw helps with security compliance:

| Requirement | T3Claw Feature |
|-------------|-----------------|
