...
T3Claw uses a zero-exposure credential model: secrets are encrypted at rest and never exposed to untrusted code.
...
t3claw secret get telegram_bot_token

# Set a secret
t3claw secret set telegram_bot_token "your-token"

# Delete a secret
t3claw secret delete telegram_bot_token
```
...
Common secret names used by T3Claw:
...
<AccordionGroup>
  ...
  <Accordion title="Secret not found" icon="search">
    ...
    - Re-run `t3claw onboard` to reconfigure
  </Accordion>
