...
description: Complete endpoint reference for the T3Claw Web Gateway API
---

The T3Claw Web Gateway exposes a REST API for all agent operations. All endpoints require bearer token authentication.
...
For remote deployments, replace with your reverse proxy domain (e.g., `https://t3claw.yourdomain.com`).
