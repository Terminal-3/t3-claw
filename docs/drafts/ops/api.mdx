...
description: Complete endpoint reference for the BastionClaw Web Gateway API
---

The BastionClaw Web Gateway exposes a REST API for all agent operations. All endpoints require bearer token authentication.
...
For remote deployments, replace with your reverse proxy domain (e.g., `https://bastionclaw.yourdomain.com`).
