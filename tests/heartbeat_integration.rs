...
async fn test_heartbeat_end_to_end() {
    ...
    let _ = tracing_subscriber::fmt()
        .with_env_filter("bastionclaw=debug")
        .try_init();
    ...
    let hb_config = bastionclaw::agent::HeartbeatConfig::default();
    let hygiene_config = bastionclaw::workspace::hygiene::HygieneConfig::default();
    ...
    println!("=== Result ===\n");
    match &result {
        bastionclaw::agent::HeartbeatResult::Ok => {
        ...
        bastionclaw::agent::HeartbeatResult::Skipped => {
        ...
        bastionclaw::agent::HeartbeatResult::Failed(err) => {
