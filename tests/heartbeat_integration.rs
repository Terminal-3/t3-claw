...
async fn test_heartbeat_end_to_end() {
    ...
    let hb_config = t3claw::agent::HeartbeatConfig::default();
    let hygiene_config = t3claw::workspace::hygiene::HygieneConfig::default();
    ...
    println!("=== Result ===\n");
    match &result {
        t3claw::agent::HeartbeatResult::Ok => {
        ...
        t3claw::agent::HeartbeatResult::Skipped => {
        ...
        t3claw::agent::HeartbeatResult::Failed(err) => {
