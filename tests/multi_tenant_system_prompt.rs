...
mod tests {
    ...
    async fn seed_identity(db: &Arc<dyn t3claw::db::Database>, user_id: &str, content: &str) {
    ...
    fn extract_system_prompt(requests: &[Vec<t3claw::llm::ChatMessage>]) -> Option<String> {
