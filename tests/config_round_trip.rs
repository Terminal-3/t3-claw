...
//! functions from `t3claw::bootstrap`, ensuring test coverage of the actual
//! escaping/formatting logic rather than a reimplementation.

use std::collections::HashMap;
use tempfile::tempdir;

use t3claw::bootstrap::{save_bootstrap_env_to, upsert_bootstrap_var_to};
...
fn bootstrap_env_preserves_existing_values() {
    ...
    assert_eq!(
        ...
        Some("postgres://user:pass@localhost:5432/t3claw"),
