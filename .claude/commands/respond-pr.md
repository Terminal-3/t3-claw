...
2. Run BastionClaw's quality gate to verify nothing breaks:
   - `cargo fmt`
...
- Follow BastionClaw conventions: no `.unwrap()` in production code, use `crate::` imports, `thiserror` errors.
