# BastionClaw ↔ OpenClaw Feature Parity Matrix

This document tracks feature parity between BastionClaw (Rust implementation) and OpenClaw (TypeScript reference implementation). Use this to coordinate work across developers.
...
| Feature | OpenClaw | BastionClaw | Notes |
|---------|----------|----------|-------|
...
| Channel | OpenClaw | BastionClaw | Priority | Notes |
|---------|----------|----------|----------|-------|
| CLI/TUI | ✅ | ✅ | - | Ratatui-based TUI |
| HTTP webhook | ✅ | ✅ | - | axum with secret validation |
| REPL (simple) | ✅ | ✅ | - | For testing |
| WASM channels | ❌ | ✅ | - | BastionClaw innovation; host resolves owner scope vs sender identity |
...
| Feature | OpenClaw | BastionClaw | Notes |
|---------|----------|----------|-------|
| DM pairing codes | ✅ | ✅ | `bastionclaw pairing list/approve`, host APIs |
...
| Command | OpenClaw | BastionClaw | Priority | Notes |
|---------|----------|----------|----------|-------|
...
| Feature | OpenClaw | BastionClaw | Notes |
|---------|----------|----------|-------|
| Pi agent runtime | ✅ | ➖ | BastionClaw uses custom runtime |
...
| Provider | OpenClaw | BastionClaw | Priority | Notes |
|----------|----------|----------|----------|-------|
...
| Tinfoil | ❌ | ✅ | - | Private inference provider (BastionClaw-only) |
...
| Feature | OpenClaw | BastionClaw | Priority | Notes |
|---------|----------|----------|----------|-------|
...
| Workspace-relative install | ✅ | ✅ | ~/.bastionclaw/tools/ |
...
| Hot-reload | ✅ | ❌ | |
| Legacy migration | ✅ | ➖ | |
| State directory | ✅ `~/.openclaw-state/` | ✅ `~/.bastionclaw/` | |
...
| Gemini embeddings | ✅ | ❌ | |
| Local embeddings | ✅ | ❌ | |
| SQLite-vec backend | ✅ | ❌ | BastionClaw uses PostgreSQL |
...
| DM pairing verification | ✅ | ✅ | bastionclaw pairing approve, host APIs |
...
| WASM sandbox | ❌ | ✅ | BastionClaw innovation |
...
- ✅ DM pairing (bastionclaw pairing list/approve, host APIs)
- ✅ WASM tool sandbox
...
BastionClaw intentionally differs from OpenClaw in these ways:
...
7. **Tinfoil private inference**: BastionClaw-only provider for private/encrypted inference
