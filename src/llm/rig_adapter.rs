//! Generic adapter that bridges rig-core's `CompletionModel` trait to T3Claw's `LlmProvider`.
//!
...
/// Convert T3Claw messages to rig-core format.
///
...
/// Convert T3Claw tool definitions to rig-core format.
///
...
/// Convert T3Claw tool_choice string to rig-core ToolChoice.
...
fn extract_response(
    ...
    for content in choice.iter() {
        match content {
            ...
            // Reasoning and Image variants are not mapped to T3Claw types
            _ => {}
        }
    }
