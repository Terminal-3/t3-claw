...
/// Convert T3Claw `ChatMessage` list into Bedrock system blocks + messages.
///
...
/// Build Bedrock `ToolConfiguration` from T3Claw tool definitions.
...
/// Map Bedrock `StopReason` to T3Claw `FinishReason`.
