// English Language Pack for BastionClaw
...
I18n.register('en', {
  ...
  // Restart Modal
  'restart.title': 'Restart BastionClaw Instance',
  'restart.description': 'Are you sure you want to restart BastionClaw? This will gracefully restart the process.',
  ...
  'restart.progressTitle': 'Restarting BastionClaw',
  ...
  'users.getLoginLink': 'Get Login Link',
  'users.loginLinkReady': 'Login link ready!',
  'users.failedGetLoginLink': 'Failed to get login link',
  'users.deleteUser': 'Delete',
  'users.deleteConfirm': 'Permanently delete "{name}" and all their data? This cannot be undone.',
  ...
  'welcome.description': 'BastionClaw is your secure AI assistant. Choose a suggestion below or type your own message.',
