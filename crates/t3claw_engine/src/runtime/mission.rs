...
use t3claw_skills::v2::{CodeSnippet, SkillRepairRecord, SkillRepairType, V2SkillMetadata};
...
mod tests {
    ...
    use t3claw_skills::SkillTrust;
    use t3claw_skills::types::ActivationCriteria;
    use t3claw_skills::v2::{SkillMetrics, SkillRepairType, V2SkillMetadata, V2SkillSource};
