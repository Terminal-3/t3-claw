//! `bastionclaw_tui` — Modular Ratatui-based TUI for BastionClaw.
//!
//! This crate provides the rendering engine, widget system, and event loop
//! for BastionClaw's terminal user interface. It is intentionally decoupled
//! from the main `bastionclaw` crate: the Channel trait bridge lives in
