...
I18n.register('zh-CN', {
  ...
  // 重启弹窗
  'restart.title': '重启 T3Claw 实例',
  'restart.description': '确定要重启 T3Claw 实例吗？这将优雅地重启进程。',
  'restart.warning': '正在运行的任务可能会中断。重启将在几秒钟内完成。',
  'restart.cancel': '取消',
  'restart.confirm': '确认重启',
  'restart.progressTitle': '正在重启 T3Claw',
  ...
  'users.deleteUser': '删除',
  'users.deleteConfirm': '永久删除"{name}"及其所有数据？此操作无法撤销。',
  'users.failedDelete': '删除用户失败',
  ...
  'welcome.description': 'T3Claw 是您的安全 AI 助手。选择下方的建议或输入您自己的消息。',
