...
pub struct BrandingConfig {
    /// Page title (replaces default "T3Claw").
    ...
    /// side (`window.__T3CLAW_LAYOUT__` and
...
/// (`window.__T3CLAW_LAYOUT__`) and the response body of
...
impl BrandingConfig {
    ...
    /// `window.__T3CLAW_LAYOUT__` JSON island. The first consumer that
...
mod tests {
    ...
    fn test_branding_serialize_drops_hostile_urls() {
        ...
        // `window.__T3CLAW_LAYOUT__` or `GET /api/frontend/layout`.
        let hostile = BrandingConfig {
