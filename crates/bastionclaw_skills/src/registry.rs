...
//! 2. User skills directory (`~/.bastionclaw/skills/`) -- Trusted
//! 3. Installed skills directory (`~/.bastionclaw/installed_skills/`) -- Installed
...
pub struct SkillRegistry {
    ...
    /// User skills directory (~/.bastionclaw/skills/). Skills here are Trusted.
    user_dir: PathBuf,
    /// Registry-installed skills directory (~/.bastionclaw/installed_skills/). Skills here are Installed.
                ...
                if !loaded_set.contains(companion.as_str()) {
                    tracing::warn!(
                        "Skill '{}' declares companion '{}' in `requires.skills`, but it is not loaded. \
                         Install it via `skill_install` or place a SKILL.md for it in ~/.bastionclaw/skills/ \
