...
pub enum SkillSource {
    ...
    Workspace(PathBuf),
    /// User skills directory (~/.bastionclaw/skills/).
    User(PathBuf),
    /// Registry-installed skills directory (~/.bastionclaw/installed_skills/).
    Installed(PathBuf),
...
/// here so that `bastionclaw_skills` remains independent of the main crate.
