...
use bastionclaw_skills::v2::{CodeSnippet, SkillRepairRecord, SkillRepairType, V2SkillMetadata};
...
mod tests {
    ...
    use bastionclaw_skills::SkillTrust;
    use bastionclaw_skills::types::ActivationCriteria;
    use bastionclaw_skills::v2::{SkillMetrics, SkillRepairType, V2SkillMetadata, V2SkillSource};
    ...
    fn build_skill_gap_payload_skips_read_only_shell_workflows() {
        ...
        thread.add_event(crate::types::event::EventKind::ActionExecuted {
            ...
            action_name: "shell".to_string(),
            call_id: "call_1".to_string(),
            params_summary: Some("gh pr list --repo nearai/bastionclaw".to_string()),
            duration_ms: 15,
        });
