...
//! 2. User skills directory (`~/.t3claw/skills/`) -- Trusted
//! 3. Installed skills directory (`~/.t3claw/installed_skills/`) -- Installed
...
pub struct SkillRegistry {
    ...
    /// User skills directory (~/.t3claw/skills/). Skills here are Trusted.
    user_dir: PathBuf,
    /// Registry-installed skills directory (~/.t3claw/installed_skills/). Skills here are Installed.
                ...
                if !loaded_set.contains(companion.as_str()) {
                    tracing::warn!(
                        "Skill '{}' declares companion '{}' in `requires.skills`, but it is not loaded. \
                         Install it via `skill_install` or place a SKILL.md for it in ~/.t3claw/skills/ \
