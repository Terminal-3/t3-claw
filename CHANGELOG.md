...
All notable changes to T3Claw will be documented here.

The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/),
and this project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).

## Merging from upstream T3Claw

T3Claw is a fork of [IronClaw](https://github.com/nearai/ironclaw). When merging upstream changes:
...
2. Resolve any conflicts — pay particular attention to `src/bootstrap.rs` (config paths),
   ...
   where T3Claw diverges from upstream.
3. Record merged upstream version below under a dedicated `### Upstream sync` heading
   so it is clear which T3Claw release the merge covers.
...
- Initial fork of IronClaw v0.25.0 as T3Claw
